...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7129284446:AAFHfchy6e_Eu_28fAfVCIxtJXq2XPNpXq8")  # ⚠️ Required
    ...
    # database config
    DB_NAME = os.environ.get("DB_NAME", "Renamebotv7")
    DB_URL = os.environ.get("DB_URL", "mongodb+srv://Renamebotv7:Renamebotv7@cluster0.0bwkpqd.mongodb.net/")  # ⚠️ Required
